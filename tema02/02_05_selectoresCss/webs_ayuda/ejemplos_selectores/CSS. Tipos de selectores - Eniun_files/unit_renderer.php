...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_61866ece55e8e"];
}else{
	jvxObjectList.push("jvx_61866ece55e8e");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=19&bDim=160x600&bUnitId=1901&siteId=45f3d18e47f96c&campaignId=145089&es_pId=nVWB85&isDynamic=1&ap_DataSignal1=47979833&ap_DataSignal2=ABAjH0hGnODndHcpxVCv0uLNgvnB&ap_DataSignal3=336214505&ap_DataSignal4=902209341526&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https://googleads.g.doubleclick.net/dbm/clk%3Fsa%3DL%26ai%3DCJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY%26sig%3DAOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw%26client%3Dca-pub-9593927860712609%26dbm_c%3DAKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA%26dbm_d%3DAKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE%26adurl%3D&r=1636200124052580") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function jvxCopyObject(target,obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_61866ece55e8e' style='display:none;'></div>")
	}
/*
JavaScript responsible for frame busting
*/
var jvx_61866ece55e8eTraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_61866ece55e8eSafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_61866ece55e8eCanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_61866ece55e8eInNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_61866ece55e8eTraffickedInFrame = true;
}

try{
		$sf.ext.register(160, 600);
		jvx_61866ece55e8eSafeFrameSupported = true;
}catch(e){
	jvx_61866ece55e8eSafeFrameSupported = false;
}
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_61866ece55e8e');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_61866ece55e8e != "undefined")
                            jvx_61866ece55e8e.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_61866ece55e8e'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_61866ece55e8e.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_61866ece55e8e.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_61866ece55e8e.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_61866ece55e8e.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_61866ece55e8e.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_61866ece55e8e.DwellRecorded){
					jvx_61866ece55e8e.recordDwellEvent(49, jvx_61866ece55e8e.DwellElapsedTime);
				}
			}
									else if(msg=="dynamicProperties") {
                jvx_61866ece55e8e.updateDYProperties(s[2],1);
							}
			else if(msg=="clickThroughUrl") { 
								jvx_61866ece55e8e.clickTagURL = s.slice(2).flat(1).join(":");
			}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_61866ece55e8e.fixedBgAstLeft = parseInt(s[3]);
                jvx_61866ece55e8e.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_61866ece55e8e' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_61866ece55e8e' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_61866ece55e8eTraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_61866ece55e8e != 'undefined'){
				finalURL += "&es_cgName_"+jvx_61866ece55e8e.DYReportingKey;
                if(jvx_61866ece55e8e.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_61866ece55e8e.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_61866ece55e8e.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_61866ece55e8eSafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_61866ece55e8e,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_61866ece55e8e.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_61866ece55e8e.baseContainerId)){
				return; 
			}
		jvx_61866ece55e8e.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_61866ece55e8e.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","addPostCode":"https:\/\/cdn.jivox.com\/files\/46220\/Nike_DV\/dv_nike.js","creativeUnitType":"19","bDim":"160x600","bUnitId":"1901","siteId":"45f3d18e47f96c","campaignId":"145089","es_pId":"nVWB85","isDynamic":"1","ap_DataSignal1":"47979833","ap_DataSignal2":"ABAjH0hGnODndHcpxVCv0uLNgvnB","ap_DataSignal3":"336214505","ap_DataSignal4":"902209341526","gdpr":"","gdpr_consent":"","jvxVer":"2","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=CJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ&ae=1&num=1&cid=CAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY&sig=AOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw&client=ca-pub-9593927860712609&dbm_c=AKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA&dbm_d=AKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE&adurl=","r":"1636200124052580","removeClickParams":"1","serverURL":"https:\/\/as.jivox.com"};
		this.campaignId = '145089';
		this.siteId = '45f3d18e47f96c';
		this.placementId = 'nVWB85';
		...
		this.asyncCompletedTaskCount = 0;
			...
			this.asyncTaskCount++;
                        ...
                        this.apParamsArr = {"ap_DataSignal1":"47979833","ap_DataSignal2":"ABAjH0hGnODndHcpxVCv0uLNgvnB","ap_DataSignal3":"336214505","ap_DataSignal4":"902209341526"};
        this.apParamsInEventFormat = "";
						this.browserName = 'Chrome';
		this.browserVersion = '95.0.4638.69';
								this.clickTagURL = 'https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ&ae=1&num=1&cid=CAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY&sig=AOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw&client=ca-pub-9593927860712609&dbm_c=AKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA&dbm_d=AKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE&adurl=http%3A%2F%2Fwww.nike.com';
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=19&bDim=160x600&bUnitId=1901&siteId=45f3d18e47f96c&campaignId=145089&es_pId=nVWB85&isDynamic=1&ap_DataSignal1=47979833&ap_DataSignal2=ABAjH0hGnODndHcpxVCv0uLNgvnB&ap_DataSignal3=336214505&ap_DataSignal4=902209341526&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY%26sig%3DAOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw%26client%3Dca-pub-9593927860712609%26dbm_c%3DAKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA%26dbm_d%3DAKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE%26adurl%3D&r=1636200124052580&objectName=jvx_61866ece55e8e&adUnitId=1901&jvxSessionId=1636200142.6140';
        			this.baseURL += '&base=1';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_61866ece55e8eSafeFrameSupported){
		         var callBackFnName ='jvx_61866ece55e8e'+".updateDYProperties";
		         jvx_61866ece55e8e.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_61866ece55e8e.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_61866ece55e8e.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
            //this.fireCREvent();
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_61866ece55e8e.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
                    ...
                    if(jvx_61866ece55e8eSafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_61866ece55e8e.sendCookieRequest('jvx_61866ece55e8e'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_61866ece55e8eSafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_61866ece55e8e"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_61866ece55e8eCanBustFromFrame || jvx_61866ece55e8eInNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "145089/45f3d18e47f96c/19/jvxSId_1636200142.6140";
                eventReportingURL += "/es_pId_nVWB85";
                tempURL += "";
				...
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ&ae=1&num=1&cid=CAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY&sig=AOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw&client=ca-pub-9593927860712609&dbm_c=AKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA&dbm_d=AKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE&adurl=http%3A%2F%2Fwww.nike.com") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_61866ece55e8e.DYReportingKey;
                    if(jvx_61866ece55e8e.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_61866ece55e8e.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_61866ece55e8e" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_61866ece55e8e");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=19&bDim=160x600&bUnitId=1901&siteId=45f3d18e47f96c&campaignId=145089&es_pId=nVWB85&isDynamic=1&ap_DataSignal1=47979833&ap_DataSignal2=ABAjH0hGnODndHcpxVCv0uLNgvnB&ap_DataSignal3=336214505&ap_DataSignal4=902209341526&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY%26sig%3DAOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw%26client%3Dca-pub-9593927860712609%26dbm_c%3DAKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA%26dbm_d%3DAKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE%26adurl%3D&r=1636200124052580&objectName=jvx_61866ece55e8e';
											this.baseURL += '&jvxSessionId=1636200142.6140';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=19&bDim=160x600&&siteId=45f3d18e47f96c&campaignId=145089&es_pId=nVWB85&isDynamic=1&ap_DataSignal1=47979833&ap_DataSignal2=ABAjH0hGnODndHcpxVCv0uLNgvnB&ap_DataSignal3=336214505&ap_DataSignal4=902209341526&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCJe5AvG6GYeSaA5vQtwem77WwA_DclY5i34z5i90Nu__vjvciEAEgqPmFMmDVhYCAtAmgAdG7iJMCyAEJqQIIvjIEumizPqgDAaoE6wFP0I9lI626j3u49XsXIvaVO95WdXzAldmUuxBNz5H5eNDJq7GMCKIWb7Gtovl7yDVhcFx78NwG5WIi_GgEeM6dyxKmbxoBRY-DUuS1oYU2-DGpfGzhmWhaMU_bxQCkG6gLezoLzAh2srsS8GKA6wTnVejuKXWUYr3rlRvr_-Ox4x0WNLJ6fP47aCbX6HQCfVnA-HYt9rJJ-ATMaewOSwpPKmHI575BSqgrg-g9ihPLLWMeaPTFTRIX0vKBDgFvvVTuLtau1k5UcSP8c9Oqij1yWrQDEC8xT3Cb06NrLlIGVEcddRKcDwaVVHv1wASlxN7ZuwPgBAOQBgGgBk2AB5fE9-wBiAcBkAcCqAfw2RuoB_LZG6gHjs4bqAeT2BuoB-6WsQKoB_6esQKoB9XJG6gHpr4bqAfz0RuoB5bYG6gHqpuxAqgH35-xAtgHANIICQiAgIAQEAIYWoAKAZgLAcgLAYAMAbAT9aeXDdATANgTDdgUAdAVAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAMSeQClSFh3500ZS_SM_VWSQddrbwv2yrDvLSp8HW0qTEiQ7mvA9kkze8Jy-1R1rX3fdUs-ip3U7g6cupsPZmlpkGW3y4witsKrPunEopSETHadMnhBw9fuE-4PD0cGMaY3KavQVc0oIIZVG9EJhV_AxY6pIIiMSoGf9HY%26sig%3DAOD64_1D6XOa4dEtjH-7yXNCZbfKS4gIIw%26client%3Dca-pub-9593927860712609%26dbm_c%3DAKAmf-DzXBEyf68CNfx81WUgIu4iYrWwAGhyOK5dnwYQpP2HhZlWmRQT2GWUpxmq3TRu16YGanb4I2YgcqllanksJfqYduCKFuq7zI-wArWDaL1aDjDZbPuFfOuejAx7l-8KWPQq0UUNhl-tO4gI2_SbJ4fW3VU1EA%26dbm_d%3DAKAmf-CAUZbWHMhqQw_TybSCcEYFVB0ct-nAAa7IyyeXu3xhf0Qa7LXp1txK1PZAnYgWERkOVBLpYXP3hJE40Q2TPAH1rDlYhtNQZK9VFkX7nCbnMsXD-iKgW0v1bidzBghjyqFpwRAfmP266FUNgBhXNF_JMPv3PlVD7tHI0V7bSDmSq8l5_xOoNsn__Zb-8drMFpi_T_DOJXfPMH4SO3wfKqoTsu5xTzfjyy1hZBMGPwiqPMysC-UCkbzShYUdN8DqcBC-f9qxy-_-bJi_jQTZc1pEnK5mL_hilSsn6hsU2nC-oP2kXlK5kZsA-HNO-p-lmWuj54CCjVJR8BBRRGSYmldK49ji8OMswhyL-6lR0D1Twnaq9lWgbWhdfl4tNrSNPT0-FbOyk7qxpvjQQxIXt5SNX6GWXkzUAWnqTRhpCe9az9CVCbFQbTzHiIZcrhojvVHLhufzRSseNF9CoPyP5_TY4FEm0JWoPunFsDMXgzlc35x8xiE%26adurl%3D&r=1636200124052580&objectName=jvx_61866ece55e8e'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1636200142.6140';
		...
		listenerCallback:function(event) {
			jvx_61866ece55e8e.eventController(event); 
		},
...
var jvx_61866ece55e8e = new CreativeUnit("_61866ece55e8e");
jvx_61866ece55e8e.DYReportingKey = "";
jvx_61866ece55e8e.DYSegmentName = "";
	if(NonMraidTagInMraidEnv){
				jvx_61866ece55e8e.recordEvent(75);
	}
    jvx_61866ece55e8e.init();
